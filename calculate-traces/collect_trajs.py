...
# Processing extra sampling 2020.06.08
# 
...
sdir = "/data/nseelam04/pros_nowat_3ltp/trace_data/TPScalc/"+ prot + "/"
#sdir = "/data/nseelam04/pros_nowat_3ltp/trace_data/extra_sampling/" + prot + "/"
#sdir = "/data/nseelam04/pros_nowat_3ltp/trace_data/" + prot + "/"

if prot == "wt":
    # Extra sampling 
    tpsdir = "/data/nseelam05/pros_nowat_3ltp_v2/wt/tpsfull_new/"
    atom_pairs = [(238, 231), (55, 56), (55, 57), (55, 58), (231, 56), (231, 57), (231, 58)]
    # Original Dir
    ...
    tpsdir = "/data/nseelam02/Apr_2017_TPS/s127a/tpsgetp_redo/"
    atom_pairs = [(134, 141), (55, 58), (55, 57), (55, 56), (134, 58), (134, 57), (134, 56)]
    ...
    tpsdir = "/data/nseelam05/pros_nowat_3ltp_v2/v155d/tpsgetp_fullnew/"
    #tpsdir = "/data/nseelam04/pros_nowat_3ltp/wt/tpsseed1_set_c2.1_c-1.2_fr53/tpsgetp_0.1win/"
    atom_pairs = [(135, 142), (55, 58), (55, 57), (55, 56), (135, 58), (135, 57), (135, 56)]#[(45, 52), (34, 37), (34, 36), (34, 35), (45, 37), (45, 36), (45, 35)]


Nframes = 651
cols = ["Atom Index", "Atom Type", "Res Name", "Chain", "Res ID", "X", "Y", "Z", "B", "Charge"]
tpswin = [3.45, 5]  #[1.75, 1.85] #[3.45, 5] #[3.1, 3.2]
